...
// --- Local Components for Home Page Sections ---
...
function HowItWorks() {
  const steps = [
  {
    ...
    desc: 'Browse our curated packages or build your own'
  },
  {
    icon: CalendarIcon,
  ...
  },
  {
    ...
    title: 'We Set Up, You Celebrate',
    desc: 'Our team handles everything while you enjoy'
  }];
...
function FeaturedPackages() {
  // Order: Ultimate Party, Party Starter, Splash Zone, Snack Fiesta
  const featuredSlugs = [
  'ultimate-party',
  'party-starter',
  'splash-zone',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Carefully curated combinations to make your party planning
            effortless.
          </p>
        </div>
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <span className="text-sm text-gray-500">
            Not sure which one? Compare packages →
          </span>
        </div>
      </div>
    </section>);
...
function WhyChooseUs() {
  ...
  {
    emoji: '🛝',
    title: 'Massive Themed Slides',
    desc: 'Three uniquely themed giant slides that turn any space into an adventure park'
  },
  {
    emoji: '🎉',
    title: 'All-In-One Party Setup',
    desc: 'From inflatables to snacks to decorations — we handle everything so you can relax'
  },
  {
    emoji: '🔒',
    title: 'Child Safety Guaranteed',
    desc: 'Professional staff supervision with safety-first equipment and protocols'
  },
  {
    emoji: '🍿',
    title: '10 Snack Machines',
    desc: 'Cotton candy, popcorn, ice cream, slush and more — a snack paradise for kids'
  },
  {
    emoji: '🚚',
    title: 'We Come To You',
    desc: 'Serving all 7 emirates — we deliver, set up, and pack up at your location'
  },
  {
    emoji: '👫',
    title: 'Male & Female Staff',
    desc: 'Comfortable for all families with both male and female team members available'
  }];
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-12">
          <div>
            ...
            <p className="text-gray-400 max-w-xl">
              A glimpse into the joy and excitement we bring to every event.
            </p>
          </div>
          <Link
            to="/gallery"
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center bg-white px-4 py-2 rounded-full shadow-sm border border-gray-100">
            ...
            <div className="flex mr-2">
              ...
              <StarIcon
                key={i}
                className={`w-4 h-4 ${i < 4 || i === 4 ? 'text-amber-400 fill-amber-400' : 'text-gray-300'}`} />
          ...
          <div
            ...
            className="border border-gray-200 rounded-xl overflow-hidden">
              ...
              className="w-full flex justify-between items-center p-6 text-left bg-white hover:bg-gray-50 transition-colors">
                ...
                <span className="font-bold text-brand-navy pr-4">
                  {faq.question}
                </span>
                <ChevronDownIcon
                className={`w-5 h-5 text-brand-pink shrink-0 transition-transform duration-300 ${openId === faq.id ? 'rotate-180' : ''}`} />
