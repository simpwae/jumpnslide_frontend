...
export function TestimonialsPage() {
  ...
  const confirmDeleteTestimonial = () => {
    if (confirmDelete) {
      setTestimonials(prev => prev.filter(item => item.id !== confirmDelete));
                ...
                {testimonials.map((testimonial) =>
                  editingId === testimonial.id ? (
                    ...
                    <TableRow key={testimonial.id}>
                      ...
                      <TableCell>
                        <Badge variant={testimonial.isFeatured ? 'success' : 'default'}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center justify-end space-x-2">
                          ...
                          <Button size="sm" onClick={() => handleSaveEdit(testimonial.id)}>
                            Save
                          </Button>
                        </div>
                      </TableCell>
                    ...
                    <TableRow key={testimonial.id}>
                      ...
                      <TableCell>
                        <button onClick={() => toggleFeatured(testimonial.id)}>
                          <Badge
                            variant={testimonial.isFeatured ? 'success' : 'default'}
